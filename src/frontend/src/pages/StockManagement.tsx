                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-[oklch(0.15_0.02_220)] text-sm">
                            {item.name}
                          </p>
                          {item.isTrending && (
                    ...
                    <td className="px-4 py-3 text-sm text-[oklch(0.4_0.03_220)]">
                      {item.category}
                    </td>
                    <td className="px-4 py-3">
                      <span
                        className={`text-sm font-medium ${Number(item.quantity) === 0 ? "text-[oklch(0.5_0.18_25)]" : item.isLowStock ? "text-[oklch(0.55_0.15_50)]" : "text-[oklch(0.15_0.02_220)]"}`}
                      >
