...
import type { ExternalBlob as _ExternalBlob, StockItem as _StockItem, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addSale(arg0: bigint, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addSale(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addStockItem(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: bigint, arg5: ExternalBlob | null, arg6: bigint | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addStockItem(arg0, arg1, arg2, arg3, arg4, await to_candid_opt_n8(this._uploadFile, this._downloadFile, arg5), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteStockItem(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getExpiredStockItems(): Promise<Array<StockItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExpiredStockItems();
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getExpiringStockItems(): Promise<Array<StockItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExpiringStockItems();
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLowStockItems(): Promise<Array<StockItem>> {
        if (this.processError) {
            try {
    ...
    async getSalesReports(): Promise<SalesReports> {
        if (this.processError) {
            try {
                const result = await this.actor.getSalesReports();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrendingStockItems(): Promise<Array<StockItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrendingStockItems();
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markTrendingStockItem(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markTrendingStockItem(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStockItem(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: bigint, arg5: bigint, arg6: ExternalBlob | null, arg7: bigint | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStockItem(arg0, arg1, arg2, arg3, arg4, arg5, await to_candid_opt_n8(this._uploadFile, this._downloadFile, arg6), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_StockItem_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StockItem): Promise<StockItem> {
...
function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        trialStartTime: value.trialStartTime
    };
}
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StockItem>): Promise<Array<StockItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_StockItem_n14(_uploadFile, _downloadFile, x)));
}
